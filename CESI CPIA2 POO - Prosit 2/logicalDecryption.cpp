...
LogicalDecryption::LogicalDecryption(string srcFile, string destFile, bool* key) : EncryptionDecryption(srcFile, destFile), Logical(key) {}

void LogicalDecryption::decrypt(void) {
